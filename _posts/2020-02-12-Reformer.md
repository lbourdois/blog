...
Les réseaux résiduels (ResNets) présentés dans [cet article](https://arxiv.org/pdf/1512.03385.pdf) par de He et al. sont des composants puissants utilisés pour aider à résoudre le problème de la disparition du gradient dans les réseaux profonds (avec de nombreuses couches). 
...
Pour résoudre ce problème, on peut utiliser le réseau résiduel réversible [(RevNet)] de Gomez et Ren (https://papers.nips.cc/paper/6816-the-reversible-residual-network-backpropagation-without-storing-activations.pdf) qui est composé d'une série de blocs réversibles. 
