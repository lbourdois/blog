...
<figure class="image">
  ...
  <figcaption> Résumé simplifié du Transformer. </figcaption>
</figure>
</center>
<br>
...
-	Problème 2 (lunettes vertes) : La profondeur des couches de feed-forward<br>
...
<figure class="image">
  ...
  <figcaption>Image provenant de la présentation de Łukasz Kaiser</figcaption>
</figure>
</center>
<br>
...
$$Y_2 = \left[Y^(1)_2; ... ; Y^(c)_2 \right] = \left[X^(1)_2 + \text{FeedForward}(Y^(1)_1); ... ;X^(c)_2+ \text{FeedForward}(Y^(c)_1)]$$
<br><br><br>
