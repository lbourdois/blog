...
En observant attentivement les blocs d'encodeur et de décodeur du Transformer (la figure avec les lunettes), on se rend compte que chaque couche d'attention et chaque couche de feedforward est enveloppée dans un bloc résiduel (partie gauche de la figure en dessous).
