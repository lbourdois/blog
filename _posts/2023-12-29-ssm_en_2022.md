...
| ![NPLR.png](https://raw.githubusercontent.com/lbourdois/blog/blob/master/assets/images/SSM_2022/Hippo.png) |
|:--:|
...
| ![NPLR.png](https://raw.githubusercontent.com/lbourdois/blog/blob/master/assets/images/SSM_2022/NPLR.png) |
|:--:|
...
| ![NPLR.png](https://raw.githubusercontent.com/lbourdois/blog/blob/master//assets/images/SSM_2022/Hippo_LegS_LegT_FouT.png) |
|:--:|
...
| ![NPLR.png](https://raw.githubusercontent.com/lbourdois/blog/blob/master/assets/images/SSM_2022/S4v2_results.png) |
|:--:|
...
A noter que softmax sur C pouvant par exemple ne pas être défini lors de sofmax (0, i \pi), les auteurs utilisent une version corrigée du softmax (détaillée dans l’annexe A.2.) pour prévenir ce problème.
...
Et notamment si $\mathrm{Re}(\lambda) \gg 0$ alors $\widetilde{x}_0 \approx u_0$ et $\widetilde{x}_k \approx \widetilde{x}_{k-1} \approx u_0$, $x_{k < L-1} \approx 0$ and $x_{L-1} \approx u_0 / \lambda$, ce qui fait que le modèle peut capturer des informations à très longues distances.
...
| ![NPLR.png](../assets/images/SSM_2022/DSS_results.png) |
|:--:|
...
| ![NPLR.png](../assets/images/SSM_2022/DSS_results2.png) |
|:--:|
...
| ![NPLR.png](../assets/images/SSM_2022/S4D_table1.png) |
|:--:|
...
Dans le S4D, le noyau de convolution $K$ de l’équation $y = u \ast \mathbf{\overline{K}} \qquad \text{où } \mathbf{\overline{K}} = (\mathbf{C}\mathbf{\overline{B}}, \mathbf{C}\mathbf{\overline{A}}\mathbf{\overline{B}}, \dots, \mathbf{C}\mathbf{\overline{A}}^{L-1}\mathbf{\overline{B}})$, se calcule de la façon suivante : 
...
$\displaystyle \mathcal{V} = {\begin{pmatrix}1&\alpha _{1}&{\alpha _{1}}^{2}&\dots &{\alpha _{1}}^{n-1}\\1&\alpha _{2}&{\alpha _{2}}^{2}&\dots &{\alpha _{2}}^{n-1}\\1&\alpha _{3}&{\alpha _{3}}^{2}&\dots &{\alpha _{3}}^{n-1}\\\vdots &\vdots &\vdots &&\vdots \\1&\alpha _{m}&{\alpha _{m}}^{2}&\dots &{\alpha _{m}}^{n-1}\\\end{pmatrix}}$. 
