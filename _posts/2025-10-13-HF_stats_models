...
<h1>Avant-propos</h1>
<p>Dans cet article, les textes dans un encadré bleu expriment uniquement nos réflexions personnelles.<br>

A titre d'information, pour les lecteurs sur téléphone, l'affichage des figures 3, 4, 13, 14 et 19 sera incomplet (nous avons visiblement encore des choses à apprendre sur plotly).<br>

Enfin, à noter que le 9 octobre dernier, Elastic a annoncé l'acquisition de Jina.ai. Nous n'avons pas eu le temps de modifier les différents graphiques pour tenir compte de cette actualité.</p>
<br><br><br>
...
<iframe
    ...
    title="Top 50 des entités par nombre total de téléchargements (détaillé au niveau des sous-comptes)"
    allowfullscreen
></iframe>
...
<details>
    ...
    <p>35. LM Studio est composée de <a href="https://huggingface.co/lmstudio-community">lmstudio-community</a> (44,1%), <a href="https://huggingface.co/bartowski">bartowski</a> (55,8%) et <a href="https://huggingface.co/lmstudio-ai">lmstudio-ai</a>.<br> A noter que nous avons vraiment hésiter à intégrer le compte bartowski à cette entité. Il se définit sur Hugging Face comme « Official model curator for https://lmstudio.ai/ » mais est surtout « Research Engineer at arcee.ai ». De plus, il est situé au Canada alors que LM Studio est au Etats-Unis. Le choix était de soit les assembler soit n'inclure aucun des deux car individuellement ne sont pas dans le top 50 (<code>answerdotai</code> étant la 51ème entité).</p>
...
<iframe
    ...
    title="Total des téléchargements par pays (pays individuels)"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Total des téléchargements par pays (UE regroupée)"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Total des téléchargements par pays (continents)"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Total des téléchargements par type d'entité"
    allowfullscreen
></iframe>
<center><i>Figure 8 : Total des téléchargements par type d'entité</i></center>
...
<iframe
    ...
    title="Total des téléchargements par type d'entité (pays individuels)"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Total des téléchargements par type d'entité (UE regroupée)"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Total des téléchargements par type d'entité (continents)"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Contributions des entités aux modalités"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Top 50 des entités Hugging Face par nombre total de téléchargements avec décomposition par modalité"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Top 50 des entités Hugging Face par nombre total de téléchargements avec décomposition par modalité (et par sous-comptes)"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Contribution des pays (individuels) aux modalités"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Contribution des pays (UE regroupée) aux modalités"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Contribution des pays (continents) aux modalités"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Contribution des entités aux tâches"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Top 50 des entités Hugging Face par nombre total de téléchargements avec décomposition par tâche"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Nombre total de téléchargements par langues"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Nombre total de téléchargements en fonction de la taille du modèle"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Nombre total de téléchargements en fonction de la taille du modèle (plus de strates)"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Nombre total de téléchargements en fonction de la taille du modèle et du type de l'entité"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Nombre total de téléchargements en fonction de la taille du modèle et de la modalité"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Nombre total de téléchargements en fonction de la taille du modèle et de la tâche"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Nombre total de téléchargements en fonction de la taille du modèle et de l'entité"
    allowfullscreen
></iframe>
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/613b0a62a14099d5afed7830/-FJAdzQE60DqvNuo0CZGt.png" 
       alt="Nombre total de téléchargements en fonction de la taille du modèle et de l'entité (focus sur Google et Meta)" 
...
<figure>
  <img src="https://cdn-uploads.huggingface.co/production/uploads/613b0a62a14099d5afed7830/D5w_p2ZXuwSbv6zG-65YR.png" 
       alt="Nombre total de téléchargements en fonction de la taille du modèle et de l'entité (modèles de plus d'un milliard de paramètres)" 
       style="max-width:100%; height:auto;">
</figure>
<center><i>Figure 28 : Nombre total de téléchargements en fonction de la taille du modèle et de l'entité (modèles de plus d'un milliard de paramètres)</i></center>
...
<iframe
    ...
    title="Nombre total de téléchargements en fonction de la taille du modèle et du pays"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Nombre total de téléchargements en fonction de la taille du modèle et du pays (UE regroupée)"
    allowfullscreen
></iframe>
...
<iframe
    ...
    title="Nombre total de téléchargements en fonction de la taille du modèle et du pays (Continents)"
    allowfullscreen
></iframe>
...
<figure>
  ...
  <img src="https://cdn-uploads.huggingface.co/production/uploads/613b0a62a14099d5afed7830/-gczIrRFbuQ-0RJ7qd_HQ.png" 
       alt="Model tree de google-bert/bert-base-uncased" 
