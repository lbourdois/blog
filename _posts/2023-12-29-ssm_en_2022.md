...
Dans le S4D, le noyau de convolution discrétisé de l’équation 
$$y = u \ast \mathbf{\overline{K}}$$ se calcule de la façon suivante : 
...
- Un opérateur associatif binaire $$\bullet$$ utilisé pour combiner les éléments. Mathématiquement, un opérateur associatif binaire étant $$ A \bullet B \bullet C = (A \bullet B)\bullet = A \bullet (B \bullet C) $$.  
