...
Maarten est co-auteur du livre [*Hands-On Large Language Models*](https://www.llm-book.com/)<br>
...
En pratique, c’est un peu plus complexe. La quantité de (V)RAM nécessaire pour l’inférence, dépend aussi de la taille du contexte et de l'architecture. <br>
...
<center>
<figure class="image">
<img src="https://raw.githubusercontent.com/lbourdois/blog/refs/heads/master/assets/images/Quantification/image_8.png">
</figure>
<figcaption>Image adaptée de l'original par [Slava Sidorov](https://pixabay.com/users/slava_web-designer-39623293/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=8668140)</figcaption>
</center>
...
Pour obtenir une plage de valeurs similaire à celle de FP32, la précision *bfloat 16* a été introduite comme un type de « FP32 tronqué » :
...
Cette quantification par bloc utilise le facteur d'échelle ($s_super$) du super-bloc pour quantifier le facteur d'échelle ($s_sub$) du sous-bloc.
...
| Nom | Quantification du poids  | Echelle (<font color="#D79617">s</font>)  de quantification (super) | Echelle (<font color="#D79617">s</font>) de quantification (sous) | Bits par poids (<font color="#B352FF">w</font>) | # Sous blocs | Poids par bloc |
| --- | --- | --- | --- | --- | --- | --- |
...
C'est là qu'intervient [BitNet](https://arxiv.org/abs/2310.11453), qui représente les poids d'un modèle avec 1 bit, en utilisant soit -1, soit 1 pour un poids donné.
...
Pendant l'entraînement, les poids sont stockés en INT8, puis quantifiés à 1 bit à l'aide d'une stratégie simple, appelée fonction signum.
...
Les activations de sortie sont redimensionnées avec {α, β} pour les déquantifier à la précision d'origine :
...
<center>
<figure class="image">
<img src="https://raw.githubusercontent.com/lbourdois/blog/refs/heads/master/assets/images/Quantification/image_56">
</figure>
</center>
...
•	Un [article de blog d’Eleuther.ai](https://blog.eleuther.ai/transformer-math/) décrivant les mathématiques de base liées au calcul et à l'utilisation de la mémoire pour les transformateurs.
...
•	Une [vidéo YouTube vraiment étonnante](https://www.youtube.com/watch?v=mii-xFaPCrA)  sur GPTQ expliquée de manière incroyablement intuitive. 
